...
<form action="/update.do" method="post">
    ...
    <div class="mb-3">
        ...
        <%-- <textarea class="form-control" id="createdAt" placeholder="createdAt" name="createdAt" value="<%=todo.getCreatedAt()%>"></textarea> --%>
        <input class="form-control" id="createdAt" placeholder="createdAt" name="createdAt" value="${todo.createdAt}" readonly>
    </div>
     <div class="mb-3">
        <label for="completed" class="form-check-label">completed</label>
        <%-- completed 가 true 면 check 표시 --%>
        <input type="checkbox"  id="completed" class="form-check-input" name="completed" value="true" <c:out value="${todo.completed?'checked':''}"/>>
    </div>
    <div class="mb-3">
